class AddDummyCouponData < ActiveRecord::Migration
  def up
    ...
    Coupon.create(:coupon_provider_id => @cp.id, :code => coupon_code, :coupon_type => "#{SecureRandom.random_number(14)+1}% discount", photo_id: 13873789, username: 'spiegeleule', user_id: 160004, printed: true)
    coupon_code = SecureRandom.hex.to_s[0..5]
